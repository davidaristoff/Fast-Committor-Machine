...
* `NN_comparison` - Contains the neural network model, training loop, and main committor_net (using  [PyTorch](https://pytorch.org/)) for comparison to the FCM.
